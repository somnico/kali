# Generated by Powerlevel10k configuration wizard on 2023-12-19 at 13:31 UTC.
...
# sharp tails, 1 line, sparse, concise, instant_prompt=verbose.
...
() {
  ...
  if [[ -n "$TMUX" ]]; then
    ...
    typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
      ...
      toolbox_joined          # toolbox name (https://github.com/containers/toolbox)
...
typeset -g POWERLEVEL9K_DIR_DEFAULT_NOT_WRITABLE_VISUAL_IDENTIFIER_EXPANSION=''
  ...
  typeset -g POWERLEVEL9K_LOAD_NORMAL_BACKGROUND=3
  # Load color when load is between 50% and 70%.
  typeset -g POWERLEVEL9K_LOAD_WARNING_FOREGROUND=0
  typeset -g POWERLEVEL9K_LOAD_WARNING_BACKGROUND=3
  # Load color when load is over 70%.
  typeset -g POWERLEVEL9K_LOAD_CRITICAL_FOREGROUND=0
  typeset -g POWERLEVEL9K_LOAD_CRITICAL_BACKGROUND=3
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_PER_DIRECTORY_HISTORY_LOCAL_BACKGROUND=3
  ...
  typeset -g POWERLEVEL9K_PYENV_BACKGROUND=3
  ...
  # Toolbox color.
  typeset -g POWERLEVEL9K_TOOLBOX_FOREGROUND=15
